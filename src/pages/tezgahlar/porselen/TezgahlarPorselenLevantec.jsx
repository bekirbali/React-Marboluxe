...
import { tezgahlarPorselenLevantec } from "../../../utils";
...
const TezgahlarPorselenLevantec = () => {
  ...
  const nextHandler = () => {
    if (page === tezgahlarPorselenLevantec.length - 1) {
      ...
      <div className="h-[120px] items-center flex-wrap flex flex-col justify-around md:items-start bg-[#f1f1f1] pl-24">
        ...
        <div className="flex justify-center items-center flex-wrap gap-1">
          ...
          <MdKeyboardDoubleArrowRight
            ...
            size={12}
          />
          <p>Levantec Porselen Tezgahlar</p>
        </div>
      </div>
      <div className="main-holder-plakalar flex justify-between w-[90%] mx-auto ">
        ...
        <div className="p-4 flex flex-col items-center flex-[4]">
          ...
          <div className="buttons flex gap-4 mt-4">
            ...
            {tezgahlarPorselenLevantec.map((item, index) => (
              <p
                key={index}
...
export default TezgahlarPorselenLevantec;
