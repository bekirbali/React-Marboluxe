...
import { tezgahlarPorselenEstestone } from "../../../utils";
...
const TezgahlarPorselenEstestone = () => {
  ...
  const nextHandler = () => {
    if (page === tezgahlarPorselenEstestone.length - 1) {
      ...
      <div className="h-[120px] items-center flex-wrap flex flex-col justify-around md:items-start bg-[#f1f1f1] pl-24">
        ...
        <div className="flex justify-center items-center flex-wrap gap-1">
          ...
          <MdKeyboardDoubleArrowRight
            ...
            size={12}
          />
          <p>Estestone Porselen Tezgahlar</p>
        </div>
      </div>
...
export default TezgahlarPorselenEstestone;
