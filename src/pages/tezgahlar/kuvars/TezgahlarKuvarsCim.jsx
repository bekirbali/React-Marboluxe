...
const TezgahlarKuvarsCim = () => {
  ...
  const nextHandler = () => {
    if (page === tezgahlarKuvarsCimstone.length - 1) {
      ...
      <div className="main-holder-plakalar flex justify-between w-[90%] mx-auto ">
        ...
        <div className="p-4 flex flex-col items-center flex-[4] mt-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 justify-center gap-4">
            {tezgahlarKuvarsCimstone[page].map((tas, index) => {
              return (
                <div
                  key={index}
          ...
          <div className="buttons flex gap-4 mt-4">
            ...
            <div className="flex flex-wrap gap-2">
              {tezgahlarKuvarsCimstone.map((item, index) => (
                <p
                  key={index}
...
export default TezgahlarKuvarsCim;
