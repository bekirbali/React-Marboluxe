...
import { plakalarKuvarsCaesarstone } from "../../../utils/index";
...
const PlakalarKuvarsCaesar = () => {
  ...
  const nextHandler = () => {
    if (page === plakalarKuvarsCaesarstone.length - 1) {
      ...
      <div className="h-[120px] items-center flex-wrap flex flex-col justify-around md:items-start bg-[#f1f1f1] pl-24">
        ...
        <div className="flex justify-center items-center flex-wrap gap-1">
          ...
          <MdKeyboardDoubleArrowRight
            ...
            size={12}
          />
          <p>Caesarstone Kuvars Plakalar</p>
        </div>
      </div>
      <div className="main-holder-plakalarKuvarsCaesar flex justify-between w-[90%] mx-auto ">
        ...
        <div className="p-4 flex flex-col items-center flex-[4]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 justify-center gap-4">
            {plakalarKuvarsCaesarstone[page].map((tas, index) => {
              return (
                <div
                  key={index}
          ...
          <div className="buttons flex gap-4 mt-4">
            ...
            {plakalarKuvarsCaesarstone.map((item, index) => (
              <p
                key={index}
...
export default PlakalarKuvarsCaesar;
