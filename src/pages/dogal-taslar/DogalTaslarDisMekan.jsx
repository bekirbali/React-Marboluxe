import { dogalTaslarDisMekan } from "../../utils";
import { Link, useNavigate } from "react-router-dom";
import SideBar from "../../components/SideBar";
import { MdKeyboardDoubleArrowRight } from "react-icons/md";

const DogalTaslarDisMekan = () => {
    ...
    <>
      ...
      <div className="main-holder-dogalTas flex justify-between w-[90%] mx-auto ">
        ...
        <div className="p-4 flex flex-col items-center flex-[4]">
          <h1 className="text-center text-3xl font-bold my-4">Dış Mekan</h1>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 justify-center gap-4 ">
            {dogalTaslarDisMekan[0].map((tas, index) => {
              return (
                <div
                  key={index}
...
export default DogalTaslarDisMekan;
