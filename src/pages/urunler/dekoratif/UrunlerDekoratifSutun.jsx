...
import { urunlerDekoratifSutun } from "../../../utils";
...
const UrunlerDekoratifSutun = () => {
  ...
  const nextHandler = () => {
    if (page === urunlerDekoratifSutun.length - 1) {
...
export default UrunlerDekoratifSutun;
