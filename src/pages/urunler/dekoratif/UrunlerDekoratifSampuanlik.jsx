...
import { urunlerDekoratifSampuanlik } from "../../../utils";
...
const UrunlerDekoratifSampuanlik = () => {
  ...
  const nextHandler = () => {
    if (page === urunlerDekoratifSampuanlik.length - 1) {
...
export default UrunlerDekoratifSampuanlik;
