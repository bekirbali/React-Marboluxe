...
import { urunlerDekoratifSupurgelik } from "../../../utils";
...
const UrunlerDekoratifSupurgelik = () => {
  ...
  const nextHandler = () => {
    if (page === urunlerDekoratifSupurgelik.length - 1) {
