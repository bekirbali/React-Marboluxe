...
import { urunlerDekoratifBahce } from "../../../utils";
...
const UrunlerDekoratifBahce = () => {
  ...
  const nextHandler = () => {
    if (page === urunlerDekoratifBahce.length - 1) {
...
export default UrunlerDekoratifBahce;
