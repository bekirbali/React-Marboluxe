...
import { urunlerDekoratifKolon } from "../../../utils";
...
const UrunlerDekoratifKolon = () => {
  ...
  const nextHandler = () => {
    if (page === urunlerDekoratifKolon.length - 1) {
...
export default UrunlerDekoratifKolon;
