...
import { urunlerDekoratifAksesuar } from "../../../utils";
...
const UrunlerDekoratifAksesuar = () => {
  ...
  const nextHandler = () => {
    if (page === urunlerDekoratifAksesuar.length - 1) {
...
export default UrunlerDekoratifAksesuar;
