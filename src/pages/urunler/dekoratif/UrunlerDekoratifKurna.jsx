...
import { urunlerDekoratifKurna } from "../../../utils";
...
const UrunlerDekoratifKurna = () => {
  ...
  const nextHandler = () => {
    if (page === urunlerDekoratifKurna.length - 1) {
...
export default UrunlerDekoratifKurna;
