...
import { urunlerWaterjetMadalyon } from "../../../utils";
...
const UrunlerWaterjetMadalyon = () => {
  ...
  const nextHandler = () => {
    if (page === urunlerWaterjetMadalyon.length - 1) {
      ...
      <div className="h-[120px] items-center flex-wrap flex flex-col justify-around md:items-start bg-[#f1f1f1] pl-24">
        ...
        <div className="flex justify-center items-center flex-wrap gap-1">
          ...
          <MdKeyboardDoubleArrowRight
            ...
            size={12}
          />
          <Link to="/urunler/waterjet">Waterjet Ürünler</Link>
          <MdKeyboardDoubleArrowRight
            className="mt-1 hover:cursor-default arrow-right"
            size={12}
          />
          <p>Waterjet Madalyon</p>
        </div>
      </div>
...
export default UrunlerWaterjetMadalyon;
