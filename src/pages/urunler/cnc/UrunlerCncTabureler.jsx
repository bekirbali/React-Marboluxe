...
import { urunlerCncTabureler } from "../../../utils";
...
const UrunlerCncTabureler = () => {
  ...
  const nextHandler = () => {
    if (page === urunlerCncTabureler.length - 1) {
...
export default UrunlerCncTabureler;
